...
class TransformerDecoder(nn.Module):
    def __init__(self, hidden_dim, decoder_layer, num_layers, eval_idx=-1,teacher=False):
...
class RTDETRTransformerv2(nn.Module):
    ...
    def __init__(self,
        ...
        self.decoder = TransformerDecoder(hidden_dim, decoder_layer, num_layers, eval_idx, teacher)
    ...
    def _get_decoder_input(self,
        ...
        if self.training or self.teacher or self.eval_spatial_size is None:
    ...
    def forward(self, feats, targets=None):
        ...
        if (self.training or self.teacher) and self.aux_loss:
