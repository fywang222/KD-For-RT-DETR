...
class COCOVisualizer():
    ...
    def visualize(self, img, tgt, caption=None, dpi=120, savedir=None, show_in_console=True, normalized_before=False):
        """
        img: tensor(3, H, W)
